const projects = [
  {
    ...
    info: "A racing simulator where users can create cars, start races, and compare their performance. The project demonstrates asynchronous requests, REST API interaction, animations, and TypeScript architecture.",
